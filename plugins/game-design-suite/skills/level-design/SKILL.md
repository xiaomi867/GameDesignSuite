---
name: level-design
description: 负责关卡、地图、波次和可玩空间设计，包括 Layout、Metrics、Blockout、路径、导航、探索、Encounter、视线、掩体、机制教学、节奏、情感曲线、Boss、Checkpoint、随机事件结构和关卡 Playtest。
---
...
- 机制教学、空间引导、心理地图 -> [Mechanic Teaching & Spatial Language](references/mechanic-teaching-and-spatial-language.md)
