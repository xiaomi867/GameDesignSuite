...
description: 负责英雄从Lv1到等级上限的基础属性成长、突破/晋阶跳变、成长副属性、职业/稀有度模板、属性曲线与阶段强度变化。用于建立或审计HP/ATK/DEF/速度/能量/暴击等等级成长，比较不同英雄的成长密度，并与技能Scaling Source交叉验证；不负责技能倍率成长，技能数值交给 skill-value-design。
---
...
- [Cross-Game Character Stat Growth Patterns](references/cross-game-character-stat-growth-patterns.md)
