---
name: meta-balance
description: 负责多角色、多Build、多队伍、多内容环境下的版本级平衡与生态健康，包括Roster/Composition/Matchup矩阵、Pick/Win/Presence、角色熟练度、Synergy、Counter、Power Creep、可用池、多样性和版本改动风险。用于回答“单体都正常为什么生态仍失衡、哪些组合挤压其他选择、版本会不会膨胀”，不把单一胜率当作完整平衡结论。
---
...
- [Meta Balance Framework](references/meta-balance-framework.md)
- [Meta Balance Source Map](references/meta-balance-source-map.md)
