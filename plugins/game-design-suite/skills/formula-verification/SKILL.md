...
description: 负责游戏内公式的建立、还原、校验、对照和压力测试，包括伤害、治疗、护盾、防御、抗性、暴击、命中、行动值、攻速/攻击间隔、资源/能量、仇恨、Gauge、DoT/异常、成长与概率公式。用于验证“公式到底怎么算、代码是否实现一致、边界是否安全、乘区是否合理”，并可参考崩铁/绝区零等公开理论计算作为比较样本；不把参考游戏公式直接当成本项目标准。
---
...
- [Formula Audit Method](references/formula-audit-method.md)
- [HSR Formula Reference](references/hsr-formula-reference.md)
- [ZZZ Formula Reference](references/zzz-formula-reference.md)
- [Formula Source Map](references/formula-source-map.md)
