...
Use `economy-design` for source/sink and inflation analysis.
...
- `simulation-design` for acquisition and graduation distributions;
- `economy-design` for resource loops and inflation;
- `progression-design` for replacement/upgrade cadence;
- `telemetry-experiment-design` for live acquisition and frustration signals;
- `meta-balance` for item-use concentration and power creep.